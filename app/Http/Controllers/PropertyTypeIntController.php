...
class PropertyTypeIntController extends Controller
{
    ...
    public function intRead(){
        ...
        $properties = Properties::join("categories", "properties.category_id", "=", "categories.id")
            ...
            ->where('properties.property_id', '=', 4)
            ->get();
    
        $property = Property::where('id', 4)->first();
    
        return view("manage.property.listINT", compact('setting', 'categories', 'property', 'properties'));
    }
    ...
    public function intEdit($id){
        ...
        $intProperties = Properties::join("categories", "properties.category_id", "=", "categories.id")
        ...
        return view("manage.property.listINT", compact('setting', 'categories', 'property',  'properties',  'intProperties'));
    }
    ...
    public function intUpdate(Request $request) {
        ...
        try {
            ...
            return redirect()->route('intEdit', ['id' => $accountCode->id])->with('success', 'Updated Successfully');
        } catch (\Exception $e) {
