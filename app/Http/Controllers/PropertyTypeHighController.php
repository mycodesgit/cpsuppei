...
class PropertyTypeHighController extends Controller
{
    ...
    public function hvRead(){
        ...
        return view("manage.property.listHV", compact('setting', 'categories', 'property', 'properties'));
    }
    ...
    public function hvEdit($id){
        ...
        $hvProperties = Properties::join("categories", "properties.category_id", "=", "categories.id")
        ...
        return view("manage.property.listHV", compact('setting', 'categories', 'property',  'properties',  'hvProperties'));
    }
    ...
    public function hvUpdate(Request $request) {
        ...
        try {
            ...
            return redirect()->route('hvEdit', ['id' => $accountCode->id])->with('success', 'Updated Successfully');
        } catch (\Exception $e) {
