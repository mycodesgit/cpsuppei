...
class PropertyTypeController extends Controller
{
    ...
    public function ppeRead(){
        ...
        $properties = Properties::join("categories", "properties.category_id", "=", "categories.id")
            ...
            ->where('properties.property_id', '=', 3)
            ->get();
    
        $property = Property::where('id', 3)->first();
    
        return view("manage.property.listPPE", compact('setting', 'categories', 'property', 'properties'));
    }
    ...
    public function ppeEdit($id){
        ...
        $ppeProperties = Properties::join("categories", "properties.category_id", "=", "categories.id")
        ...
        return view("manage.property.listPPE", compact('setting', 'categories', 'property',  'properties',  'ppeProperties'));
    }
    ...
    public function ppeUpdate(Request $request) {
        ...
        try {
            ...
            return redirect()->route('ppeEdit', ['id' => $accountCode->id])->with('success', 'Updated Successfully');
        } catch (\Exception $e) {
