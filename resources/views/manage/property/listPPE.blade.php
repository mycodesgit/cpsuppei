                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="account_title_abbr" name="account_title_abbr" value="{{ $cr == 'ppeEdit' ? $ppeProperties->account_title_abbr : '' }}" class="form-control" oninput="this.value = this.value.toUpperCase()" placeholder="Enter Account Title Type">
                                </div>
                            </div>
                        </div>
