...
<ul class="nav nav-pills nav-sidebar nav-compact flex-column">
    <li class="nav-item mb-1">
        <a href="#propertySubmenu" data-toggle="collapse" aria-expanded="false" class="nav-link2 {{ ($ppeActive || $lvActive) ? 'active' : '' }}" style="color: #000;" onclick="toggleSubmenu(this)">
        ...
        <ul class="collapse list-unstyled" id="propertySubmenu">
            <li class="nav-item mb-1 mt-1">
                <a href="{{ route('ppeRead') }}" class="nav-link2 {{ $ppeActive }}" style="color: #000;">
                    <i class="far fa-circle nav-icon"></i> PPE
                </a>
            </li>

            <li class="nav-item">
                <a href="{{ route('lvRead') }}" class="nav-link2 {{ $lvActive }}" style="color: #000;">
                    <i class="far fa-circle nav-icon"></i> Low Value
                </a>
            </li>
        </ul>
    </li>
