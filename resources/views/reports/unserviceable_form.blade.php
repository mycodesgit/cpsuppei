                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control select2bs4" id="office_id" name="office_id" style="width: 100%;" onchange="genUnserviceable(this.value, 'campus', this.options[this.selectedIndex].getAttribute('data-person-cat'))" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="category_id" name="categories_id" onchange="categor(this.value)" data-placeholder="---Select Category---" class="form-control select2bs4" style="width: 100%;" required>
                                        <option></option>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control select2bs4" id="person_accnt" data-placeholder="Select Accountable" onchange="genUnserviceable(this.value, 'user', this.options[this.selectedIndex].getAttribute('data-person-cat'))" name="person_accnt" style="width: 100%;" required>
                                        <option></option>
...
function genUnserviceable(val, type, pAccountable) {
    ...
    var urlTemplate = "{{ route('genOptionUnserv') }}";
